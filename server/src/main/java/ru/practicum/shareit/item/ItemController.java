...
public class ItemController {
    ...
    public ItemResponse create(@RequestBody NewItemRequest newItem,
                               @RequestHeader("X-Sharer-User-Id") Long userId
    ) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public CommentResponse addCommaent(@RequestBody NewCommentRequest newCommentRequest,
                                       @RequestHeader("X-Sharer-User-Id") Long userId,
    ...
    @PatchMapping("/{itemId}")
    public ItemResponse update(@RequestBody UpdateItemPatchRequest updateItem,
                               @PathVariable Long itemId,
                               @RequestHeader("X-Sharer-User-Id") Long userId
    ) {
